<%@ Page Language="C#" AutoEventWireup="true" CodeFile="list_school.aspx.cs" Inherits="manager_list_school" %>
        ...
        <asp:GridView ID="GridView1" runat="server" AllowSorting="True" 
            ...
            <Columns>
                <asp:TemplateField HeaderText="پاسخ">
                    <ItemTemplate>
                        <asp:Label ID="Label1" runat="server" Height="100px" Width="300px"></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
            ...
            <EmptyDataTemplate>
                هیچ پیامی&nbsp; رسیدگی نشده ای&nbsp; برای پرینت وجود ندارد
            </EmptyDataTemplate>
        </asp:GridView>
    </center>
    </div>
